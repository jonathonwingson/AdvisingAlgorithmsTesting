...
// run using "npm run test_case_1.4"
// 
...
describe('Degree Progress Test and Eligible Courses for TestCase:\n  1.4 - Student completed some of the required courses and none of the courses are offered.', function () {

    const programmeId = 1;
    const file_path = '/workspaces/AdvisingAlgorithmsTesting/TestCase - 1.4.xlsx';
