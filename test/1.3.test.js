...
// run using "npm run test_case_1.3"
// 
...
describe('Degree Progress Test and Eligible Courses for TestCase:\n  1.3 - Student completed some of the required courses and all the courses are offered.', function () {

    const programmeId = 1;
    const file_path = '/workspaces/AdvisingAlgorithmsTesting/TestCase - 1.3.xlsx';
    ...
    it('Should calculate the correct courses a student can register for', function () {
        ...
        const expectedEligibleCourses = [
            'COMP1602', 'COMP1603', 'COMP1604',
            'COMP2601', 'COMP2602', 'COMP2603',
            'COMP2604', 'COMP2605', 'COMP2606',
            'COMP2611', 'COMP3601', 'COMP3603',
            'COMP3605', 'COMP3606', 'COMP3607',
            'COMP3609', 'COMP3610', 'COMP3611',
            'COMP3612', 'COMP3613', 'FOUN1105',
            'FOUN1301', 'INFO1601', 'INFO2602',
            'INFO2604', 'INFO2605', 'INFO3600',
            'INFO3604', 'INFO3605', 'INFO3606',
            'INFO3607', 'INFO3608', 'INFO3609',
            'INFO3611', 'MATH2250'
        ];
